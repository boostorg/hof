...
BOOST_FIT_STATIC_TEST_CASE()
{
    ...
    static_assert(boost::fit::is_callable<fn, callable_rank<0>&, int>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, callable_rank<1>&, int>::value, "Failed");
    static_assert(!boost::fit::is_callable<fn, callable_rank<0>&>::value, "Failed");
    static_assert(!boost::fit::is_callable<fn, callable_rank<0> const&, int>::value, "Failed");
};
...
BOOST_FIT_STATIC_TEST_CASE()
{
    ...
    static_assert(boost::fit::is_callable<fn, T&, int>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, DT&, int>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, const T&, int>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, T&&, int>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, ST, int>::value, "Failed");
    static_assert(!boost::fit::is_callable<fn, CT&, int>::value, "Failed");
...
BOOST_FIT_STATIC_TEST_CASE()
{
    ...
    static_assert(!boost::fit::is_callable<fn>::value, "Failed");
};
...
BOOST_FIT_STATIC_TEST_CASE()
{
    ...
    static_assert(boost::fit::is_callable<fn, callable_rank<0>&>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, callable_rank<0>&&>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, const callable_rank<0>&>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, callable_rank<1>&>::value, "Failed");
};
...
BOOST_FIT_STATIC_TEST_CASE()
{
    ...
    static_assert(boost::fit::is_callable<fn, T&>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, DT&>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, const T&>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, T&&>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, ST>::value, "Failed");
    static_assert(boost::fit::is_callable<fn, CT&>::value, "Failed");
...
BOOST_FIT_STATIC_TEST_CASE()
{
    ...
    static_assert(boost::fit::is_callable<fp, callable_rank<0>&, int>::value, "Failed");
    static_assert(boost::fit::is_callable<fp, callable_rank<1>&, int>::value, "Failed");
    static_assert(!boost::fit::is_callable<fp, const callable_rank<0>&, int>::value, "Failed");
    static_assert(!boost::fit::is_callable<fp>::value, "Failed");
    static_assert(!boost::fit::is_callable<fp, callable_rank<0>&>::value, "Failed");
};
