...
struct pipe_closure : F, Pack
{
    ...
    BOOST_FIT_NOEXCEPT(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(F, X&&) && BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(Pack, P&&))
    : F(BOOST_FIT_FORWARD(X)(fp)), Pack(BOOST_FIT_FORWARD(P)(packp))
    {}
    ...
    struct invoke
    {
        ...
        BOOST_FIT_NOEXCEPT(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(A, X&&))
        : a(BOOST_FIT_FORWARD(X)(xp)), self(selfp)
        {}
