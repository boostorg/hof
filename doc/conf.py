# -*- coding: utf-8 -*-
#
# Boost.Fit documentation build configuration file, created by
...
def parse_version():
    lines = open('../include/boost/fit/version.hpp').readlines()
    defines = ['BOOST_FIT_VERSION_MAJOR', 'BOOST_FIT_VERSION_MINOR', 'BOOST_FIT_VERSION_PATCH']
    versions = ['0','0','0']
    for line in lines:
...
htmlhelp_basename = 'Boost.Fitdoc'
...
latex_documents = [
    (master_doc, 'Boost.Fit.tex', u'Boost.Fit Documentation',
...
man_pages = [
    (master_doc, 'fit', u'Boost.Fit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Boost.Fit', u'Boost.Fit Documentation',
     author, 'Boost.Fit', 'One line description of project.',
     'Miscellaneous'),
]
