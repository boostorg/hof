...
#if !BOOST_FIT_HAS_CONSTEXPR_LAMBDA || !BOOST_FIT_HAS_INLINE_LAMBDAS
...
#if BOOST_FIT_HAS_CONSTEXPR_LAMBDA
#define BOOST_FIT_STATIC_LAMBDA []
#else
...
#if BOOST_FIT_HAS_INLINE_LAMBDAS
#define BOOST_FIT_STATIC_LAMBDA_FUNCTION BOOST_FIT_STATIC_FUNCTION
#else
...
BOOST_FIT_STATIC_AUTO_REF name = BOOST_FIT_DETAIL_MAKE_REVEAL_STATIC(fit_private_static_function_ ## name)
#endif
