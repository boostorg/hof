...
: std::integral_constant<bool, (
    BOOST_FIT_IS_CONSTRUCTIBLE(T, const T&)
)>
{};
...
, int>::type = 0>
constexpr T pack_get(X&& x, Ts&&... xs) noexcept(BOOST_FIT_IS_NOTHROW_COPY_CONSTRUCTIBLE(T))
{
    return static_cast<T>(boost::fit::alias_value<Tag, T>(BOOST_FIT_FORWARD(X)(x), xs...));
}
...
{
    return boost::fit::alias_value<Tag, T>(x, xs...);
}
...
(
    boost::fit::alias_value<Tag, T>(BOOST_FIT_FORWARD(X)(x), xs...)
);
...
: Ts::type...
{
    ...
    BOOST_FIT_NOEXCEPT(BOOST_FIT_AND_UNPACK(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(typename Ts::type, Xs&&)))
...
: pack_holder_base<typename pack_holder_builder<Ts...>::template apply<Ts, Ns>...>
{
    ...
    BOOST_FIT_NOEXCEPT(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(base, X1&&, X2&&, Xs&...))
    : base(BOOST_FIT_FORWARD(X1)(x1), BOOST_FIT_FORWARD(X2)(x2), BOOST_FIT_FORWARD(Xs)(xs)...)
    {}

    template<class X1, typename std::enable_if<(BOOST_FIT_IS_CONSTRUCTIBLE(base, X1)), int>::type = 0>
    constexpr pack_base(X1&& x1)
    BOOST_FIT_NOEXCEPT(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(base, X1&&))
    ...
    (
        f(boost::fit::detail::pack_get<Ts, pack_tag<seq<Ns>, Ts...>>(*BOOST_FIT_CONST_THIS, f)...)
    );
...
: pack_holder_base<pack_holder<T, pack_tag<seq<0>, T>>>
{
    ...
    constexpr auto operator()(F&& f) const BOOST_FIT_RETURNS
    (
        f(boost::fit::detail::pack_get<T, pack_tag<seq<0>, T>>(*BOOST_FIT_CONST_THIS, f))
    );
...
: pack_holder<Ts, pack_tag<seq<Ns>, Ts...>>::type...
{
    ...
    BOOST_FIT_NOEXCEPT(BOOST_FIT_AND_UNPACK(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(typename pack_holder<Ts, pack_tag<seq<Ns>, Ts...>>::type, Xs&&)))
    : pack_holder<Ts, pack_tag<seq<Ns>, Ts...>>::type(BOOST_FIT_FORWARD(Xs)(xs))...
    {}
...
BOOST_FIT_RETURNS(f(boost::fit::alias_value<pack_tag<seq<Ns>, Ts...>, Ts>(move(x), f)...))
...
struct pack_join_base<pack_base<seq<Ns1...>, Ts1...>, pack_base<seq<Ns2...>, Ts2...>>
{
    ...
    BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(
        result_type(
            boost::fit::detail::pack_get<Ts1, pack_tag<seq<Ns1>, Ts1...>>(BOOST_FIT_FORWARD(P1)(p1))..., 
            boost::fit::detail::pack_get<Ts2, pack_tag<seq<Ns2>, Ts2...>>(BOOST_FIT_FORWARD(P2)(p2))...)
    )
    {
        return result_type(
            boost::fit::detail::pack_get<Ts1, pack_tag<seq<Ns1>, Ts1...>>(BOOST_FIT_FORWARD(P1)(p1))..., 
...
struct pack_f
{
    ...
    constexpr auto operator()(Ts&&... xs) const BOOST_FIT_RETURNS
    (
        pack_basic_f()(boost::fit::decay(BOOST_FIT_FORWARD(Ts)(xs))...)
    );
};

template<class P1, class P2>
constexpr typename pack_join_result<P1, P2>::result_type make_pack_join_dual(P1&& p1, P2&& p2)
BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(pack_join_result<P1, P2>::call(BOOST_FIT_FORWARD(P1)(p1), BOOST_FIT_FORWARD(P2)(p2)))
{
...
template<class P1>
constexpr P1 make_pack_join(P1&& p1) BOOST_FIT_NOEXCEPT_CONSTRUCTIBLE(P1, P1&&)
{
...
BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(make_pack_join_dual(BOOST_FIT_FORWARD(P1)(p1), make_pack_join(BOOST_FIT_FORWARD(Ps)(ps)...)))
{
...
BOOST_FIT_DECLARE_STATIC_VAR(pack_basic, detail::pack_basic_f);
