...
FIT_TEST_CASE()
{
    static_assert(noexcept(fit::reverse_compress(max_f(), 0)(2, 3, 4, 5)), "noexcept reverse_compress");
    static_assert(noexcept(fit::reverse_compress(sum_f(), 0)(2, 3, 4, 5)), "noexcept reverse_compress");
    static_assert(!noexcept(fit::reverse_compress(sum_f(), std::string())("hello", "-", "world")), "noexcept reverse_compress");
}
#endif
