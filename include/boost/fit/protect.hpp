...
/// [`lazy`](/include/boost/fit/lazy) eargerly evaluates nested bind expressions.
/// The `protect` adaptor masks the type so `bind` or
/// [`lazy`](/include/boost/fit/lazy) no longer recognizes the function as bind
...
struct protect_adaptor : detail::callable_base<F>
{
    ...
    BOOST_FIT_INHERIT_CONSTRUCTOR(protect_adaptor, detail::callable_base<F>)
};
