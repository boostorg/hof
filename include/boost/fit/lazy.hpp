...
struct ref_transformer
{
    ...
    BOOST_FIT_SFINAE_RETURNS(boost::fit::always_ref(x.get()));
};
...
struct id_transformer
{
    ...
    BOOST_FIT_SFINAE_RETURNS(always_detail::always_base<T>(BOOST_FIT_FORWARD(T)(x)));
};
...
constexpr auto lazy_transform(T&& x, const Pack& p) BOOST_FIT_RETURNS
(
...
: detail::compressed_pair<F, Pack>
{
    ...
    BOOST_FIT_NOEXCEPT_CONSTRUCTIBLE(base_type, X&&, Y&&)
...
BOOST_FIT_NOEXCEPT_CONSTRUCTIBLE(lazy_invoker<F, Pack>, F&&, Pack&&)
{
...
BOOST_FIT_NOEXCEPT_CONSTRUCTIBLE(lazy_nullary_invoker<F>, F&&)
{
...
struct lazy_adaptor : detail::callable_base<F>
{
    ...
    (
        boost::fit::detail::make_lazy_invoker(BOOST_FIT_RETURNS_C_CAST(detail::callable_base<F>&&)(BOOST_FIT_CONST_THIS->base_function(x, xs...)), 
            boost::fit::pack_basic(BOOST_FIT_RETURNS_STATIC_CAST(T&&)(x), BOOST_FIT_RETURNS_STATIC_CAST(Ts&&)(xs)...))
    );
    ...
    BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(
        boost::fit::detail::make_lazy_nullary_invoker(BOOST_FIT_RETURNS_C_CAST(detail::callable_base<F>&&)(
            BOOST_FIT_CONST_THIS->base_function(BOOST_FIT_RETURNS_CONSTRUCT(Unused)())
        ))
    )
    {
