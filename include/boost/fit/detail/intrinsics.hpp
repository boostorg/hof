...
// #define BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(...) std::is_nothrow_constructible<__VA_ARGS__>::value
...
#define BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(...) __is_nothrow_constructible(__VA_ARGS__)
...
#define BOOST_FIT_IS_POLYMORPHIC(...) __is_polymorphic(__VA_ARGS__)
#define BOOST_FIT_IS_FINAL(...) __is_final(__VA_ARGS__)
#define BOOST_FIT_IS_NOTHROW_COPY_CONSTRUCTIBLE(...) __has_nothrow_copy(__VA_ARGS__)
// *** gcc ***
...
#define BOOST_FIT_IS_FINAL(...) (false)
#else
#define BOOST_FIT_IS_FINAL(...) __is_final(__VA_ARGS__)
#endif
#define BOOST_FIT_IS_NOTHROW_COPY_CONSTRUCTIBLE(...) __has_nothrow_copy(__VA_ARGS__)
...
#define BOOST_FIT_IS_POLYMORPHIC(...) std::is_polymorphic<__VA_ARGS__>::value
#if defined(_MSC_VER)
#define BOOST_FIT_IS_NOTHROW_COPY_CONSTRUCTIBLE(...) (std::is_nothrow_copy_constructible<__VA_ARGS__>::value || std::is_reference<__VA_ARGS__>::value)
#else
#define BOOST_FIT_IS_NOTHROW_COPY_CONSTRUCTIBLE(...) std::is_nothrow_copy_constructible<__VA_ARGS__>::value
#endif
#if defined(_MSC_VER)
#define BOOST_FIT_IS_FINAL(...) __is_final(__VA_ARGS__)
#else
...
#define BOOST_FIT_IS_NOTHROW_MOVE_CONSTRUCTIBLE(...) BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(__VA_ARGS__, __VA_ARGS__ &&)
