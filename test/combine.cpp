...
BOOST_FIT_TEST_CASE()
{
    BOOST_FIT_TEST_CHECK(
        boost::fit::combine(
            ...
            boost::fit::capture_basic(1)(boost::fit::construct<std::pair>()),
            boost::fit::capture_basic(2)(boost::fit::construct<std::pair>())
        )(2, 4) 
...
BOOST_FIT_TEST_CASE()
{
    BOOST_FIT_TEST_CHECK(
        boost::fit::combine(
            ...
            boost::fit::capture_basic(1)(boost::fit::construct<mini_pair>()),
            boost::fit::capture_basic(2)(boost::fit::construct<mini_pair>())
        )(2, 4) 
