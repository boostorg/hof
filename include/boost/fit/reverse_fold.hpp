...
#ifndef BOOST_FIT_GUARD_REVERSE_FOLD_H
#define BOOST_FIT_GUARD_REVERSE_FOLD_H
...
/// 
///     int main() {
///         assert(boost::fit::reverse_fold(max_f())(2, 3, 4, 5) == 5);
///     }
/// 
/// References
/// ----------
...
: detail::compressed_pair<detail::callable_base<F>, State>
{
    ...
    BOOST_FIT_INHERIT_CONSTRUCTOR(reverse_fold_adaptor, base_type)
    ...
    BOOST_FIT_RETURNS_CLASS(reverse_fold_adaptor);
    ...
    (
        detail::v_reverse_fold()(
            ...
            BOOST_FIT_MANGLE_CAST(State)(BOOST_FIT_CONST_THIS->get_state(xs...)), 
...
{
    BOOST_FIT_INHERIT_CONSTRUCTOR(reverse_fold_adaptor, detail::callable_base<F>)
...
BOOST_FIT_DECLARE_STATIC_VAR(reverse_fold, detail::make<reverse_fold_adaptor>);
