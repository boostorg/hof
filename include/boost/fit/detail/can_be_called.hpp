...
: std::conditional<BOOST_FIT_IS_CLASS(U) && !BOOST_FIT_IS_FINAL(U), U, is_callable_wrapper_fallback<U>>
{};
...
struct can_be_called_impl<F, callable_args<Args...>, typename detail::holder<
    decltype( boost::fit::detail::called_val<F>()(boost::fit::detail::called_val<Args>()...) )
>::type>
: std::true_type
{};
