...
/// The `BOOST_FIT_STATIC_FUNCTION` macro allows initializing a function object from a
...
/// [`boost::fit::reveal`](/include/boost/fit/reveal) adaptor to improve error messages.
/// 
/// Example
/// -------
/// 
...
#if !BOOST_FIT_HAS_INLINE_VARIABLES
...
#if BOOST_FIT_HAS_INLINE_VARIABLES
#define BOOST_FIT_STATIC_FUNCTION(name) inline const constexpr auto name = boost::fit::detail::reveal_static_const_factory()
#else
#define BOOST_FIT_STATIC_FUNCTION(name) BOOST_FIT_STATIC_CONST_VAR(name) = BOOST_FIT_DETAIL_MSVC_CONSTEXPR_DEDUCE boost::fit::detail::reveal_static_const_factory()
#endif
