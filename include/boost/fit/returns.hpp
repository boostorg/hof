...
/// -----------
/// 
/// The `BOOST_FIT_RETURNS` macro defines the function as the expression
...
/// be used inside the `BOOST_FIT_RETURNS` macro because it is considered an
...
// move constructors.
#define BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(...) BOOST_FIT_NOEXCEPT(noexcept(__VA_ARGS__))
#else
#define BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(...) BOOST_FIT_NOEXCEPT(noexcept(decltype(__VA_ARGS__)(__VA_ARGS__)))
#endif
#define BOOST_FIT_RETURNS(...) \
BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(__VA_ARGS__) \
...
// Since decltype can't be used in noexcept on MSVC, we can't check for noexcept
// move constructors.
#define BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(...) BOOST_FIT_NOEXCEPT(noexcept(BOOST_FIT_RETURNS_DECLTYPE_CONTEXT(__VA_ARGS__)))
#else
#define BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(...) BOOST_FIT_NOEXCEPT(noexcept(decltype(BOOST_FIT_RETURNS_DECLTYPE_CONTEXT(__VA_ARGS__))(BOOST_FIT_RETURNS_DECLTYPE_CONTEXT(__VA_ARGS__))))
#endif

#define BOOST_FIT_RETURNS_DECLTYPE(...) \
-> decltype(BOOST_FIT_RETURNS_DECLTYPE_CONTEXT(__VA_ARGS__))
...
#define BOOST_FIT_RETURNS(...) \
BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(__VA_ARGS__) \
BOOST_FIT_RETURNS_DECLTYPE(__VA_ARGS__) \
{ BOOST_FIT_RETURNS_RETURN(__VA_ARGS__); }
