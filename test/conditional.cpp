...
BOOST_FIT_TEST_CASE()
{
    BOOST_FIT_TEST_CHECK(boost::fit::conditional(boost::fit::identity, boost::fit::identity)(3) == 3);
}
...
BOOST_FIT_TEST_CASE()
{
    typedef boost::fit::conditional_adaptor<throw_fo<t1>, no_throw_fo<t2>> fun;
    auto g = fun{};
...
BOOST_FIT_TEST_CASE()
{
    typedef boost::fit::conditional_adaptor<no_throw_fo<t2>, throw_fo<t1>> fun;
    auto g = fun{};
    static_assert(noexcept(g(t2{})), "noexcept conditional");
    static_assert(!noexcept(g(t1{})), "noexcept conditional");
...
BOOST_FIT_TEST_CASE()
{
    static_assert(noexcept(boost::fit::conditional_adaptor<no_throw_fo<t2>, throw_fo<t1>>{}(t2{})), "noexcept conditional");
    static_assert(!noexcept(boost::fit::conditional_adaptor<no_throw_fo<t2>, throw_fo<t1>>{}(t1{})), "noexcept conditional");

    static_assert(noexcept(boost::fit::conditional(no_throw_fo<t2>{}, throw_fo<t1>{})(t2{})), "noexcept conditional");
    static_assert(!noexcept(boost::fit::conditional(no_throw_fo<t2>{}, throw_fo<t1>{})(t1{})), "noexcept conditional");
}
#endif
}
