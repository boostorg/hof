...
#define BOOST_FIT_SFINAE_RETURNS(...) BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(__VA_ARGS__) { return __VA_ARGS__; }
...
#define BOOST_FIT_SFINAE_MANUAL_RETURNS(...) BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(__VA_ARGS__) { return (__VA_ARGS__); }
#else
#define BOOST_FIT_SFINAE_MANUAL_RETURNS(...) BOOST_FIT_RETURNS_DEDUCE_NOEXCEPT(__VA_ARGS__) { BOOST_FIT_RETURNS_RETURN(__VA_ARGS__); }
#endif
