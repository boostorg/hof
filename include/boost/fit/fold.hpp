...
#ifndef BOOST_FIT_GUARD_FOLD_H
#define BOOST_FIT_GUARD_FOLD_H
...
///     };
///     int main() {
///         assert(boost::fit::fold(max_f())(2, 3, 4, 5) == 5);
///     }
/// 
/// References
/// ----------
...
: detail::compressed_pair<detail::callable_base<F>, State>
{
    ...
    BOOST_FIT_INHERIT_CONSTRUCTOR(fold_adaptor, base_type)
    ...
    BOOST_FIT_RETURNS_CLASS(fold_adaptor);
...
{
    BOOST_FIT_INHERIT_CONSTRUCTOR(fold_adaptor, detail::callable_base<F>)
...
BOOST_FIT_DECLARE_STATIC_VAR(fold, detail::make<fold_adaptor>);
