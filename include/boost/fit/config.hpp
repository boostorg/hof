...
#ifndef BOOST_FIT_GUARD_CONFIG_HPP
#define BOOST_FIT_GUARD_CONFIG_HPP
...
#define BOOST_FIT_HAS_STD_17 1
#else
#define BOOST_FIT_HAS_STD_17 0
#endif

#if __cplusplus >= 201402
#define BOOST_FIT_HAS_STD_14 1
#else
#define BOOST_FIT_HAS_STD_14 0
#endif

#if __cplusplus >= 201103
#define BOOST_FIT_HAS_STD_11 1
#else
#define BOOST_FIT_HAS_STD_11 0
#endif
...
// optimization.
#ifndef BOOST_FIT_HAS_EBO
#ifdef __clang__
#define BOOST_FIT_HAS_EBO 1
#else
#define BOOST_FIT_HAS_EBO 0
#endif
#endif
...
#endif
#else
#define BOOST_FIT_HAS_RELAXED_CONSTEXPR BOOST_FIT_HAS_STD_14
#endif
#endif
...
#else
#define BOOST_FIT_HAS_GENERIC_LAMBDA BOOST_FIT_HAS_STD_14
#endif
#endif

// Whether the compiler supports constexpr lambdas
#ifndef BOOST_FIT_HAS_CONSTEXPR_LAMBDA
#if defined(__cpp_constexpr) && __cpp_constexpr >= 201603
#define BOOST_FIT_HAS_CONSTEXPR_LAMBDA 1
#else
#define BOOST_FIT_HAS_CONSTEXPR_LAMBDA BOOST_FIT_HAS_STD_17
#endif
#endif

// Whether the compiler supports inline variables
#ifndef BOOST_FIT_HAS_INLINE_VARIABLES
#if defined(__cpp_inline_variables)
#define BOOST_FIT_HAS_INLINE_VARIABLES 1
#else
#define BOOST_FIT_HAS_INLINE_VARIABLES BOOST_FIT_HAS_STD_17
#endif
#endif

// Whether inline variables defined with lambdas have external linkage.
// Currently, no compiler supports this yet.
#ifndef BOOST_FIT_HAS_INLINE_LAMBDAS
#define BOOST_FIT_HAS_INLINE_LAMBDAS 0
#endif

// Whether the compiler supports variable templates
#ifndef BOOST_FIT_HAS_VARIABLE_TEMPLATES
#if defined(__clang__) && __clang_major__ == 3 && __clang_minor__ < 5
#define BOOST_FIT_HAS_VARIABLE_TEMPLATES 0
#elif defined(__cpp_variable_templates)
#define BOOST_FIT_HAS_VARIABLE_TEMPLATES 1
#else
#define BOOST_FIT_HAS_VARIABLE_TEMPLATES BOOST_FIT_HAS_STD_14
#endif
#endif
...
#if !BOOST_FIT_HAS_MANGLE_OVERLOAD || (defined(__GNUC__) && !defined (__clang__))
...
#ifndef BOOST_FIT_HAS_NOEXCEPT_DEDUCTION
#if defined(__GNUC__) && !defined (__clang__) && ((__GNUC__ == 4 && __GNUC_MINOR__ < 8) || (__GNUC__ == 7 && __GNUC_MINOR__ == 1))
#define BOOST_FIT_HAS_NOEXCEPT_DEDUCTION 0
#else
#define BOOST_FIT_HAS_NOEXCEPT_DEDUCTION 1
#endif
#endif
