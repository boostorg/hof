...
///     BOOST_FIT_STATIC_FUNCTION(logger) = boost::fit::decorate(logger_f());
///     
///     struct sum_f
///     {
...
: compressed_pair<compressed_pair<D, T>, F>
{
    ...
    BOOST_FIT_INHERIT_CONSTRUCTOR(decorator_invoke, base)
...
: compressed_pair<D, T>
{
    ...
    BOOST_FIT_NOEXCEPT(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(decorator_invoke<D, T, detail::callable_base<F>>, compressed_pair<D, T>, detail::callable_base<F>&&))
    {
...
struct decorate_adaptor : detail::callable_base<F>
{
    ...
    BOOST_FIT_NOEXCEPT(BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(base, const base&) && BOOST_FIT_IS_NOTHROW_CONSTRUCTIBLE(T, T&&))
    {
